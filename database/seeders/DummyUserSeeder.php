...
class DummyUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataSeeders = [
            ...
            ['id' => 3, 'name' => 'DanhHa', 'email' => 'nvnamphuong99@gmail.com', 'phone' => '0912345678', 'images' => 'avata-3.jpg', 'role_id' => '2', 'email_verified_at' => $date, 'password' => Hash::make('12345678'), 'reset_password_token' => 'NULL', 'reset_password_token_expire' => $date, 'remember_token' => null, 'created_at' => $date, 'updated_at' => $date],
        ];
