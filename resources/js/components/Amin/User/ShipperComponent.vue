        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form @submit.prevent="AddShip()" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="exampleInputEmail1">Name Shipper</label>
                  <input
                    type="text"
                    class="form-control"
      ...
      <div class="table-responsive">
        <table class="table table-striped b-t b-light">
          ...
          <transition-group type="slide-fade" tag="tbody">
            <tr v-for="(ship, index) in ships" :key="ship.id">
              ...
              <td>
                <div class="td-action">
                  <a
                    ...
                    data-target="#myModal"
                    @click="
                      updateShip(ship), ((buttonAdd = false), (edit = true))
                    "
  ...
  methods: {
    ...
    AddShip() {
      ...
      if (this.edit == false) {
        ...
        formData.append("name", this.ship.name);
        formData.append("email", this.ship.email);
        formData.append("password", this.ship.password);
        axios
          .post(`ship-add`, formData, {
            headers: {
        ...
        formData.append("password", this.ship.password);
        axios
          .post(`ship/${that.ship.id}/update`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
    ...
    updateShip(ship) {
      ...
      this.ship.email = ship.email;
      this.ship.password = ship.password;
    },
    ...
    fetchData(page) {
      ...
      axios
        ...
        .then(function (response) {
          that.ships = response.data.data; //show data ra
