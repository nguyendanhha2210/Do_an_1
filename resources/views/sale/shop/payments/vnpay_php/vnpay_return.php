...
<body>
    ...
    $vnp_Returnurl = "https://fresh-mama.herokuapp.com/vnpay_php/vnpay_return.php";
    ...
    $secureHash =  hash('sha512', $hashData, $vnp_HashSecret);
                ...
                <label>
                    ...
                    if ($secureHash == $vnp_SecureHash) {
                        if ($_GET['vnp_ResponseCode'] == '00') {
                            ...
                            $sql = Payment::where('order_id', $order_id)->get();
                            $row = $sql->count();
                            ...
                            if ($row > 0) {
                                ...
                                $sql->totalMoney = $money;
                                $sql->note = $note;
                                $sql->vnp_response = $vnp_response_code;
                                $sql->code_vnpay = $code_vnpay;
                                $sql->code_back = $code_bank;
                                $sql->save();
