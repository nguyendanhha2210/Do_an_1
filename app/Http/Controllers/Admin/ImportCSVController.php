...
use App\Imports\ExcelWarehouseImports;
use App\Imports\ExcelProductImports;
use Excel;
...
class ImportCSVController extends Controller
{
    ...
    public function importProductCsv(Request $request)
    {
        ...
        $path1 = $request->file('file')->store('temp');
        $path = storage_path('app') . '/' . $path1;
        // Excel::import(new ExcelProductImports, $path);
        Excel::import(new ExcelWarehouseImports, $path);
        return back();
    } 
}
